      ...
      <main className='mx-auto grid max-w-[1280px] px-6'>
        <div className='relative mx-auto mt-10 w-full px-6 sm:mt-7'>
          ...
          <section className='w-full sm:w-[30%] sm:h-[70vh] overflow-y-scroll  sticky top-32 z-10 mb-7'>
            ...
            <div
              onClick={()=>{scrollTo(eligibility, '+', 70)}}
              className='mb-[7px] cursor-pointer font-semibold text-[13px] sm:text-[14px] lg:text-[16px]'
            >
              Eligibility
            </div>
            <div
              onClick={()=>{scrollTo(accountCreation, '+', 70)}}
              className='mb-[7px] cursor-pointer font-semibold text-[13px] sm:text-[14px] lg:text-[16px]'
            >
              Account Creation and Maintenance
            </div>
            <div
              onClick={()=>{scrollTo(serviceTerms, '+', 70)}}
              className='mb-[7px] cursor-pointer font-semibold text-[13px] sm:text-[14px] lg:text-[16px]'
            >
              Service and Terms of Use
            </div>
            <div
              onClick={()=>{scrollTo(prohibitedActivities, '+', 70)}}
            ...
            <div
              onClick={()=>{scrollTo(orderPayment, '+', 70)}}
            ...
            <div
              onClick={()=>{scrollTo(returnsRefunds, '+', 70)}}
            ...
            <div
              onClick={()=>{scrollTo(thirdPartyContent, '+', 70)}}
            ...
            <div
              onClick={()=>{scrollTo(privacyPolicy, '+', 70)}}
            ...
            <div
              onClick={()=>{scrollTo(disclaimer, '+', 70)}}
            ...
            <div
              onClick={()=>{scrollTo(limitationsLiability, '+', 70)}}
            ...
            <div
              onClick={()=>{scrollTo(indemnification, '+', 70)}}
            ...
            <div
              onClick={()=>{scrollTo(governingLaw, '+', 70)}}
            ...
            <div
              onClick={()=>{scrollTo(changesTerms, '+', 70)}}
            ...
            <div
              onClick={()=>{scrollTo(severability, '+', 70)}}
            ...
            <div
              onClick={()=>{scrollTo(termination, '+', 70)}}
            ...
            <div
              onClick={()=>{scrollTo(disputeResolution, '+', 70)}}
            ...
            <div
              onClick={()=>{scrollTo(entireAgreement, '+', 70)}}
          ...
          >
            <div ref={introduction}>
              ...
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                ...
                (the “Site” or "Website"). These Terms and Conditions ("Terms",
                “Terms and Conditions”) govern your access to and use of the
                Website, including any content, functionality, and services
                offered on or through the Website (collectively, the
                "Services"). The Services is owned and operated by A- Pure
                Lifestyle Pharmacy Nigeria Limited ("Company", "we", "us", or
                "our"), a private limited liability company registered in
                Nigeria.
              </p>
              <p className='text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                Please read these Terms carefully before using the Service. Your
                access to and use of the Services (even just browsing through
                the Website) is conditioned on your acceptance of and/or
                compliance with these Terms. These Terms apply to all visitors,
                users, and others who access or use the Services, who are
            ...
            <div ref={accountCreation}>
              ...
              <p className='mb-5 text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                ...
                (including any financial information provided to access the
                Services), including but not limited to maintaining the
            ...
            <div ref={serviceTerms}>
              ...
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                ...
                telemedicine services via the Telehealth portal, scheduling of
                laboratory tests, booking of vaccination appointments, and
                personalized wellness plans
              </p>
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                We reserve the right to modify, suspend, or discontinue any part
                of our Services at any time without notice or liability.
              </p>
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                All product descriptions, pricing, and availability are subject
                to change without notice. We reserve the right to limit the
                quantities of any products or Services that we offer.
              </p>
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                You acknowledge that the availability and delivery of products
                and services may be subject to factors beyond our control,
                including supply chain issues, regulatory approvals, and
                geographic limitations. Delivery times are estimates and not
                guaranteed. We are not liable for any delays in delivery.
              </p>
              <div className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                Telemedicine services provided through the Website are not
                intended to replace your primary care physician or other
                healthcare providers. By using our telemedicine services, you
                acknowledge that you understand and agree to the limitations of
                telemedicine, including without limitation:
                {telemedicineInfo && (
              ...
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                In case of a medical emergency, you should immediately call your
                local emergency services.
              </p>
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                You acknowledge that while we strive to protect your privacy and
                confidentiality, no internet-based service can be 100% secure,
                and you accept the inherent privacy risks associated with using
                online telemedicine services.
              </p>
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                We reserve the right to refuse or cancel telemedicine services
                at our discretion.
              </p>
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                Wellness plans provided through the Website are for
                informational purposes only and do not constitute medical
                advice. You should consult with a healthcare professional before
                starting any new diet, exercise program, or wellness plan.
              </p>
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
            ...
            <div ref={orderPayment}>
              ...
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                By placing an order for any of our Services, you are making an
                offer to purchase the products in your order. All orders are
              ...
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                ...
                you are authorized to use the designated payment method and that
                you permit us to charge your payment method for the total amount
                of your purchase (including any applicable taxes and other
                charges).
              </p>
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                All prices are listed in Nigerian Naira (NGN) unless otherwise
                specified. We reserve the right to change prices for products or
                services at any time without notice.
              </p>
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                While we strive to provide accurate pricing information, errors
                may occur. We reserve the right to correct any errors and to
                cancel any orders placed based on inaccurate pricing
                information.
              </p>
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                If you dispute any charges, please contact our customer service
                department immediately. You agree to submit any disputes within
                30 days of the charge date, otherwise, you waive your right to
                dispute such charges.
              </p>
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                We may use third-party payment processors to facilitate payment
                transactions. Your use of such services is subject to the
                applicable third-party payment processor's terms and conditions
              </p>
            </div>
            <div ref={returnsRefunds}>
              ...
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                Our return and refund policy will be separately provided on the
                Website and is incorporated into these Terms by reference.
              </p>
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
            ...
            <div ref={thirdPartyContent}>
              ...
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
              Our Site may include links to external websites (“Third-Party Websites”) and may feature articles, photos, text, graphics, designs, music, videos, information, applications, software, and other materials from third parties (“Third-Party Content”).
              </p>
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
              We do not review or monitor Third-Party Websites or Third-Party Content for accuracy, appropriateness, or completeness. We are not responsible for any Third-Party Websites accessed through our Site or any Third-Party Content available on, linked to, or installed from our Site, including their content, accuracy, reliability, opinions, privacy practices, or policies.
              </p>
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
              The inclusion of links to or access to Third-Party Websites and Third-Party Content does not imply our endorsement or approval. If you choose to leave our Site to visit Third-Party Websites or use Third-Party Content, you do so at your own risk, and our Terms and Conditions no longer apply.
              </p>
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
              We recommend reviewing the terms and privacy policies of any Third-Party Websites you visit or applications you use or install from our Site. Any transactions or purchases made through Third-Party Websites are handled directly with those third parties, and we accept no responsibility for such transactions.
              </p>
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
              You acknowledge that we do not endorse products or services offered on Third-Party Websites and agree to hold us harmless from any damages or issues arising from your use or purchase of such products or services. This includes any losses or harm resulting from interactions with Third-Party Content or Third-Party Websites.
              </p>
            </div>
            <div ref={privacyPolicy}>
              ...
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
              We care about data privacy and security. By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms and Conditions. Please be advised the Site is hosted in Nigeria.
              </p>
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
              You acknowledge that the information you provide to us, including health-related information, may be sensitive and confidential. We will handle such information in accordance with applicable data protection laws and our Privacy Policy.
              </p>
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
            ...
            <div ref={disclaimer}>
              ...
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                ...
                Your use of the site and our services is at your own risk. To
                the fullest extent permitted by Nigerian law, we disclaim all
                warranties, whether express or implied, related to the Site and
                your use of it. This includes, but is not limited to, implied
                warranties of merchantability, fitness for a particular purpose,
                and non-infringement.
              </p>
              <div className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                We do not guarantee the accuracy or completeness of the Site’s
                content or any content on linked websites. We will not be liable
                for:
                {disclaimerInfo && (
                  <ul className='ml-5 list-disc'>
              ...
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                ...
                through the Site, any linked websites, or any third-party
                features. We are not responsible for monitoring transactions
                between you and third-party providers of products or services.
                As with any purchase or service acquisition, we advise you to
                exercise caution and use your best judgment.
              </p>
            </div>
            <div ref={limitationsLiability}>
              ...
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                Under no circumstances shall we, or our directors, employees, or
                agents, be liable to you or any third party for any direct,
                indirect, consequential, exemplary, incidental, special, or
                punitive damages as a result of your access to or use of or
                inability to access or use the Services. This includes, but is
                not limited to, lost profits, lost revenue, loss of data, or
            ...
            <div ref={indemnification}>
              ...
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                ...
                our successors-in-title, subsidiaries, affiliates, and all of
            ...
            <div ref={governingLaw}>
              ...
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                ...
                Nigeria. Any legal suit, action, or proceeding arising out of,
            ...
            <div ref={changesTerms}>
              ...
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                We reserve the right to change, modify, or alter these Terms at
                our discretion and without prior notice. Your continued use of
                the Services following the posting of revised Terms means that
                you accept and agree to the changes.
              </p>
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                Additionally, we may modify or discontinue all or part of the
                Site at any time without notice. We will not be liable to you or
                any third party for any changes, price adjustments, suspension,
                or discontinuation of the Site.
              </p>
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                We cannot guarantee that the Site will be available at all
                times. The Site may experience interruptions, delays, or errors
                due to hardware, software, or other issues, including necessary
                maintenance.
              </p>
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                Nothing in these Terms and Conditions obligates us to maintain,
                support, or provide corrections, updates, or releases for the
                Site.
              </p>
            </div>
            <div ref={severability}>
              ...
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                ...
                Conditions is found to be unlawful, void, or unenforceable, that
                provision or part of a provision will be deemed severable from
                these Terms and Conditions. The remaining provisions will
                continue to be valid and enforceable, and the validity and
            ...
            <div ref={disputeResolution}>
              ...
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                ...
                “Parties”), the Parties agree to first attempt to amicably
                negotiate and/or resolve any Dispute informally for at least 45
                days before initiating Arbitration. Such informal negotiations
                commence upon written notice from one Party to the other Party.{' '}
                <br />
                If the Parties are unable to resolve a Dispute through informal
                negotiations within the aforementioned timeframe, then on the
                application of any of the Parties (notice of such application
                being given to the other Party), the dispute shall be referred
                to a single arbitrator appointed by the Chairman of the Nigerian
                branch of the Chartered Institute of Arbitrators (CIArb) to be
                resolved by Arbitration. <br />
                The arbitration proceedings shall be conducted in accordance
                with the Arbitration and Mediation Act 2023. The venue and seat
                of the arbitration shall be Lagos, Nigeria.
              </p>
            </div>
            <div ref={entireAgreement}>
              ...
              <p className='mb-[20px] text-justify text-[#5A5A5A] text-[13px] sm:text-[14px] lg:text-[16px]'>
                ...
                published by us on the Services, constitute the entire agreement
