        ...
        <main className='mx-auto grid max-w-[1280px] px-6'>
          <div className='custom-width relative mt-5 sm:mt-5'>
            <div className='flex flex-col-reverse sm:flex-row sm:gap-[5%]'>
              <section className='sticky top-32 z-10 mb-7 mt-[10px] w-full sm:h-[450px] sm:w-[30%]'>
              ...
              <section className='flex w-full flex-col gap-6 sm:w-[65%]'>
                <div ref={introduction}>
                  ...
                  <p className='mb-[20px] text-justify text-[13px] text-[#5A5A5A] sm:text-[14px] lg:text-[16px]'>
                    ...
                    A- Pure Lifestyle Pharmacy Nigeria Limited (“Pure Life’ or
                    “we”, “us”, or “our”) and applies to our website{' '}
                    <a
                    ...
                    (“Site” or “Website”), and any other services or
                    interactions related to our products and services
                    (collectively, the `Services`). This Policy is designed to
                    provide persons or entities who interact with us or who
                    utilize our Services (“users”, “you” or “your”) with an
                    understanding of how we collect, use, share, store, and
                    safeguard information of users on our Website.
                  </p>
                ...
                <div ref={personalData}>
                  ...
                  <p className='mb-5 text-justify text-[13px] text-[#5A5A5A] sm:text-[14px] lg:text-[16px]'>
                    ...
                    subscribe to our newsletter, respond to a survey or fill out
                    a form, we may collect various types of personal data,
                    including but not limited to contact information, health
                    information, usage information, device information, payment
                    information, IP address, log data, browser time.
                  </p>

                  <p className='mb-5 text-justify text-[13px] text-[#5A5A5A] sm:text-[14px] lg:text-[16px]'>
                    By giving us this information, you agree to this information
                    being collected, used and disclosed as described in this
                    privacy policy.
                  </p>
                  ...
                  <p className='mb-5 text-justify text-[13px] text-[#5A5A5A] sm:text-[14px] lg:text-[16px]'>
                    ...
                    Website or receive certain Services.
                  </p>
                </div>
                <div ref={howWeCollect}>
                  ...
                  <p className='mb-[20px] text-justify text-[13px] text-[#5A5A5A] sm:text-[14px] lg:text-[16px]'>
                    We gather your personal data from various sources,
                    including:
                  </p>
                  {collectInfo && (
                ...
                <div ref={usePersonalData}>
                  ...
                  <p className='mb-[20px] text-justify text-[13px] text-[#5A5A5A] sm:text-[14px] lg:text-[16px]'>
                    Our commitment to transparency is unwavering, and we handle
                    your personal data with the utmost responsibility. We use
                ...
                <div ref={sharing}>
                  ...
                  <p className='mb-[20px] text-justify text-[13px] text-[#5A5A5A] sm:text-[14px] lg:text-[16px]'>
                    At Pure Life, we prioritize the protection of your personal
                    data and are committed to maintaining your privacy. However,
                    there are specific situations where we may disclose your
                ...
                <div ref={storage}>
                  ...
                  <p className='mb-[20px] text-justify text-[13px] text-[#5A5A5A] sm:text-[14px] lg:text-[16px]'>
                    We take the security and confidentiality of your personal
                    data seriously. Your information will be stored in
                    compliance with industry standards and best practices. Your
                    data will be stored on secure servers, and access will be
                    limited to authorized personnel who need the information to
                    fulfill their responsibilities.
                  </p>
                  <p className='mb-[20px] text-justify text-[13px] text-[#5A5A5A] sm:text-[14px] lg:text-[16px]'>
                    Please note that while we take every reasonable precaution
                    to protect your personal data, no method of transmission or
                    storage over the internet is completely secure. We cannot
                    guarantee the absolute security of your data. Therefore, we
                    encourage you to take steps to protect your personal
                    information, such as maintaining strong and unique passwords
                    and ensuring the confidentiality of your account
                    credentials.
                  </p>
                  <p className='mb-[20px] text-justify text-[13px] text-[#5A5A5A] sm:text-[14px] lg:text-[16px]'>
                    We will retain your personal data for as long as it is
                    necessary to fulfill the purposes outlined in this privacy
                    policy, or until you withdraw your consent for the use of
                    your personal data. This is a case-by-case determination
                    that is dependent on various factors like the nature of the
                    data, why it is collected and processed, and relevant legal
                    or operational retention needs.
                  </p>
                </div>
                <div ref={security}>
                  <h2 className=' my-4 font-semibold sm:text-[20px] lg:text-[24px]'>
                  ...
                  <p className='mb-[20px] text-justify text-[13px] text-[#5A5A5A] sm:text-[14px] lg:text-[16px]'>
                    We take precautions to protect your data. Wherever we
                    collect any sensitive data, that data is encrypted and
                    transmitted to us in a secure way.
                  </p>
                  <p className='mb-[20px] text-justify text-[13px] text-[#5A5A5A] sm:text-[14px] lg:text-[16px]'>
                    The security of the storage includes firewall policies and
                    password policies to prevent unauthorized access. We shall
                    take precautionary measures to protect your data against
                    accidental loss and from unauthorized access, use,
                    alteration, and disclosure. However, despite our efforts, no
                    security controls are 100% effective, and we cannot ensure
                    or warrant the security of the data you provide to us. There
                    is no guarantee that the data may not be accessed,
                    disclosed, altered, or destroyed by breach of any of our
                    physical, technical, or managerial safeguards.
                  </p>
                  <p className='mb-[20px] text-justify text-[13px] text-[#5A5A5A] sm:text-[14px] lg:text-[16px]'>
                    Pure Life shall not be liable for any claims whether direct,
                    consequential, incidental, special, exemplary or punitive
                    damages of any nature including loss of data, revenue,
                    anticipated profit or intangible losses (even if Pure Life
                    has been advised of the possibility of such damages).
                  </p>
                  <p className='mb-[20px] text-justify text-[13px] text-[#5A5A5A] sm:text-[14px] lg:text-[16px]'>
                    The Website may, from time to time, contain links to other
                    websites. If you follow a link to any of these websites,
                    please note that they may have their own privacy policies
                    and that we do not accept any responsibility or liability
                    for these policies or websites. Please check these privacy
                    policies before you submit any data. This policy applies
                    only to information collected by the Website and by us and
                    not to other websites that you may link to from here.
                  </p>
                </div>
                <div ref={consent}>
                  <h2 className=' my-4 font-semibold sm:text-[20px] lg:text-[24px]'>
                  ...
                  <p className='mb-[20px] text-justify text-[13px] text-[#5A5A5A] sm:text-[14px] lg:text-[16px]'>
                    ...
                    processing, and use of your personal information as
                    described in this Privacy Policy. You have the right to
                    access, update, correct, or delete your personal
                    information. You may also request that we restrict or object
                ...
                <div ref={cookies}>
                  ...
                  <p className='mb-[20px] text-justify text-[13px] text-[#5A5A5A] sm:text-[14px] lg:text-[16px]'>
                    Our website uses cookies. Cookies are small data files that
                    are placed on your device (computer, mobile phone, or
                    tablet) when you visit a website. Cookies allow the website
                    to recognize your device and store some information about
                    your preferences or past actions.
                  </p>
                  <p className='mb-[20px] text-justify text-[13px] text-[#5A5A5A] sm:text-[14px] lg:text-[16px]'>
                    We use cookies and other tracking technologies to enhance
                    your user experience, improve our Services, and personalize
                    your interactions with us. You can control cookies through
                ...
                <div ref={changesToPolicy}>
                  ...
                  <p className='mb-[20px] text-justify text-[13px] text-[#5A5A5A] sm:text-[14px] lg:text-[16px]'>
                    ...
                    information practices. Any changes will be effective
                    immediately upon posting on our Website. We encourage you to
                    periodically review this page for the latest information on
                    our privacy policy practices. If you continue to use the
                    Services after those changes are in effect, you agree to the
                    revised policy.
                  </p>
                </div>
                <div ref={contactDetails}>
                  ...
                  <p className='mb-[20px] text-justify text-[13px] text-[#5A5A5A] sm:text-[14px] lg:text-[16px]'>
                    If you have questions or comments regarding our privacy
                    policy or privacy practices, you can do so by sending a mail
                    to hello@purelifehealth.io and your request will be handled
                    immediately.
                  </p>
                </div>
              </section>
