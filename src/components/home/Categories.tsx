  ...
  return (
    <Section>
      ...
      <div className='relative'>
        ...
        className='scrollbar-none mx-auto mt-20 w-[88%] grid grid-flow-col grid-rows-2 scroll-smooth gap-6 overflow-x-scroll'
        style={{
          scrollSnapType: "x mandatory", // Ensures smooth snapping when scrolling
        }}
      >
        {repeatedCategories.map((category) => (
          <div className='flex h-[160px] w-[160px] items-center justify-center rounded-full border border-[#E7E7E7]'>
